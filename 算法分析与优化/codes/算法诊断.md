...
![算法诊断-线性回归拟合](../attachments/diagnose_lr_fitting.png)

![算法诊断-线性回归学习曲线](../attachments/diagnose_lr_curve.png)
...
![算法诊断-多项式回归学习曲线](../attachments/diagnose_pr_curve.png)

借此知道了在$$\lambda=0.001$$的时候，交叉验证集误差最小，此时我们绘制拟合曲线：

![算法诊断-多项式回归拟合曲线](../attachments/diagnose_pr_fitting.png)
