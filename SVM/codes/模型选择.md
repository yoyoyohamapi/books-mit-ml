...
在新的一组样本中，我们将通过**交叉验证集**选择模型，参数 $$C$$ 和 高斯核的参数 $$\delta$$ 我们都将在以下 8 个值中选取测试，则总共构成了 $$ 8 \times 8 = 64$$ 个模型：
...
测试结果如下，在 $$C=1.0, \delta=0.10$$ 时，模型的交叉验证集误差最低：

<div style="text-align: center">
<img src="../attachments/model_selection.png" width="500"></img>
</div>
