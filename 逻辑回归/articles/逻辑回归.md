...
<img src="../attachments/sigmoid函数.jpg" width="500"></img>
</div>

可以看到，预测函数 $$h_\theta(x)$$ 被很好地限制在了 0、1 之间，并且，sigmoid 是一个非常好的阈值函数：阈值为 $$0.5$$，大于 $$0.5$$ 为 1 类，反之为 0 类，且函数曲线过渡光滑自然，关于 $$0.5$$ 中心对称也极具美感。
...
<div style="text-align:center">
<img src="../attachments/代价函数1.png" width="500"></img>
</div>

<div style="text-align:center">
<img src="../attachments/代价函数2.png" width="500"></img>
</div>
